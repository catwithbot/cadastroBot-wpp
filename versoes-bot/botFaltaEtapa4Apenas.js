...
async function createAccount(
  ...
  try {
    ...
    await page.type("input[name='cardNumber']", numeroCartao);
    await page.type("input[name='cardHolderName']", nome); // Nome no cartão
    await page.type("input[name='cardExpiryDate']", validadeCartao); // Validade do cartão
    await page.type("input[name='cardCvv']", cvv); // CVV do cartão
