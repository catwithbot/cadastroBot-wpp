...
async function autoCompleteTest() {
  ...
  try {
    ...
    await page.type("#name", "Maria Teste da Silva");
    await page.type("#email", "teste@email.com");
    await page.type("#phone", "11987654321");
    await page.type("#cpf", "74842997745");
    ...
    await page.type("#zipCode", "21073-050");
    await page.type("#street", "Rua Delfim Carlos");
    await page.type("#neighborhood", "Olaria");
    await page.type("#number", "224");
    await page.type("#complement", "Bloco A");
    ...
    console.error("Erro durante o teste de cadastro:", error.message);

    await page.screenshot({ path: "error_test.png" });
    console.log("Captura de tela salva como 'error_test.png'.");
  } finally {
    console.log(
      "Teste finalizado. O navegador permanecerá aberto para inspeção."
    );
  }
}
